class ProfileManager {
    ...
    crear() {
        const perfil = {
            ...
            costoMantenimientoPorHora: 0,
            desperdicioMaterial: parseFloat(document.getElementById('desperdicioMaterialPerfil').value) || 5,
    ...
    editar(id) {
        ...
        document.getElementById('intervaloMantenimientoPerfil').value = perfil.intervaloMantenimiento;
        document.getElementById('desperdicioMaterialPerfil').value = perfil.desperdicioMaterial;
                ...
                <div class="profile-item ${esActivo ? 'active-profile' : ''}">
                    <div style="flex: 1;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 10px; margin: 8px 0;">
                            ...
                            <div><strong>Electricidad:</strong> €${perfil.costoElectricidad}/kWh</div>
                            <div><strong>Mantenimiento:</strong> €${perfil.costoMantenimiento} cada ${perfil.intervaloMantenimiento}h</div>
                            <div><strong>Desperdicio:</strong> ${perfil.desperdicioMaterial}%</div>
    ...
    limpiarFormulario() {
        const campos = [
            ...
            'desperdicioMaterialPerfil', 'recargoMultiMaterialPerfil', 'bufferErroresPerfil'
        ];
